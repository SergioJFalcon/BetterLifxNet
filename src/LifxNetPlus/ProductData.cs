...
namespace LifxNetPlus {
	...
	public class Features {
		...
		/// </summary>
		public List<int> min_ext_mz_firmware_components { get; set; } = new List<int>();

		/// <summary>
		/// Range of supported color temperatures
		/// </summary>
		public List<int> temperature_range { get; set; } = new List<int>();
	}
	...
	public class ProductData {
		...
		/// Loads the data
		/// </summary>
		/// <returns>A list of product data</returns>
